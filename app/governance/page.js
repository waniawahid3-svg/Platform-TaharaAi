    ...
    <div className="gvx">
          ...
          <nav className="nav">
            <div className="nav-in">
              ...
              <div className="links">
                <Link data-i18n="nOverview" href="/overview">Overview</Link>
                <a className="on" data-i18n="nGov" href="#">Governance</a>
                <Link data-i18n="nFw" href="/framework">Frameworks</Link>
              ...
              <div className="nav-r">
                ...
                <Link className="out" data-i18n="signout" href="/">Sign out</Link>
              </div>
            </div>
          </nav>
          ...
          <div className="wrap">
                        ...
                        <div className="donut">
                          <svg viewBox="0 0 96 96" width="96" height="96">
                            <defs><linearGradient id="dg" x1="0" y1="0" x2="1" y2="1">
                              <stop offset="0" stopColor="#2F6FD8"/><stop offset="1" stopColor="#69A5FF"/>
                            </linearGradient></defs>
            ...
            <div className="panel" id="pReach">
              <div className="plate center-plate wiz" id="reachPlate">
                <div className="medal"><span className="halo hb"></span><span className="halo hr"></span><span className="rip"></span><span className="rip r2"></span><span className="disc"><svg className="ic-wait" viewBox="0 0 24 24" fill="none"><rect x="3.2" y="5.2" width="17.6" height="13.6" rx="2.2" stroke="currentColor" strokeWidth="1.6"/><path d="m4.6 7.4 7.4 5.4 7.4-5.4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg><svg className="ic-check" viewBox="0 0 24 24" fill="none"><path d="m5.4 12.6 4.4 4.4L18.8 6.8" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
                <div id="rfForm">
                  <h1 className="display" style={{fontSize:'26px'}} data-i18n="reachT">A specific framework, scoped with you.</h1>
                  <p className="lede wiz-lede" style={{fontSize:'13.5px'}} data-i18n="reachP">Regional and named standards are onboarded per organisation. Leave a work email and our team scopes it with you.</p>
                  <div className="reachrow"><input type="email" id="reachEm" placeholder="you@company.com" dir="ltr" /><button className="btn pri" id="reachBtn" data-i18n="reachCta">Request scoping →</button></div>
                  <div className="wiz-actions"><button className="btn" id="reachBack" data-i18n="reachBack">← Change path</button></div>
                </div>
                <div id="rfDone" style={{display:'none'}}>
                  <h1 className="display" style={{fontSize:'26px'}} data-i18n="reachDT">We will get back to you.</h1>
                  <p className="lede wiz-lede" style={{fontSize:'13.5px'}}><span data-i18n="reachDP1">Your request is with the team. Expect a reply at</span> <b id="reachEmOut" className="emchip"></b> <span data-i18n="reachDP2">within five working days.</span></p>
                  <div className="wiz-actions">
                    <button className="btn" id="reachBack2" data-i18n="reachBack2">← Back to start</button>
                    <button className="btn pri" id="reachMaster" data-i18n="reachMaster">Use the master framework →</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="panel" id="pSent">
              <div className="plate center-plate wiz">
                <div className="medal"><span className="halo hb"></span><span className="halo hr"></span><span className="rip"></span><span className="rip r2"></span><span className="disc"><svg viewBox="0 0 24 24" fill="none"><path d="M6 4.5h12l2.5 8.5v5a1.5 1.5 0 0 1-1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5v-5L6 4.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/><path d="M3.5 13h4.6l1.7 2.6h4.4l1.7-2.6h4.6" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/></svg></span></div>
                <h1 className="display" style={{fontSize:'26px'}} data-i18n="sentT">Request received.</h1>
                <p className="lede wiz-lede" style={{fontSize:'13.5px'}}><span data-i18n="sentP1">We are building the control library for</span> <b id="sentFw" className="fwchip"></b> <span data-i18n="sentP2">and mapping it into the master set.</span></p>
                <p className="wiz-fine"><span data-i18n="sentP3">We will email</span> <b id="sentEm" className="emchip"></b> <span data-i18n="sentP4">when it is live. Typical turnaround: five working days.</span></p>
                <div className="wiz-actions">
            ...
            <div className="panel" id="pVerify">
              <div className="plate center-plate wiz pend" id="verPlate">
                <div className="medal"><span className="halo hb"></span><span className="halo hr"></span><span className="rip"></span><span className="rip r2"></span><span className="disc"><svg className="ic-wait" viewBox="0 0 24 24" fill="none"><rect x="3.2" y="5.2" width="17.6" height="13.6" rx="2.2" stroke="currentColor" strokeWidth="1.6"/><path d="m4.6 7.4 7.4 5.4 7.4-5.4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg><svg className="ic-check" viewBox="0 0 24 24" fill="none"><path d="m5.4 12.6 4.4 4.4L18.8 6.8" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
                <h1 className="display" style={{fontSize:'26px'}} id="verHeadline" data-i18n="verHeadPending">Verifying your email.</h1>
                <p className="lede wiz-lede" style={{fontSize:'13.5px'}} id="verSub" data-i18n="verSubPending">We sent a confirmation link to <b id="verEmOut" className="emchip"></b>. This assessment starts once it is verified.</p>
                <p className="wiz-fine" id="verFine" data-i18n="verFinePending">Usually a few seconds in this demo. In production, this waits for the actual click.</p>
                <div className="wiz-actions">
            ...
            <div className="panel" id="p3">
              <div className="plate center-plate wiz">
                <div className="medal"><span className="halo hb"></span><span className="halo hr"></span><span className="rip"></span><span className="rip r2"></span><span className="disc"><svg viewBox="0 0 24 24" fill="none"><path d="M20.2 12.7a2.9 2.9 0 0 1-2.9 2.9h-6l-4.4 3.9v-3.9H5.7a2.9 2.9 0 0 1-2.9-2.9V6.9A2.9 2.9 0 0 1 5.7 4h11.6a2.9 2.9 0 0 1 2.9 2.9v5.8Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/><circle cx="8" cy="9.9" r="1.15" fill="currentColor"/><circle cx="12" cy="9.9" r="1.15" fill="currentColor"/><circle cx="16" cy="9.9" r="1.15" fill="currentColor"/></svg></span></div>
                ...
                <p className="lede wiz-lede" data-i18n="launchP">
                ...
                <div className="scopechips" id="scopeChips"></div>
