  ...
  return (
    <div className="ovx">
          ...
          <div className="page">
            ...
            <section className="hxr" id="hero">
              <div className="hx-wrap">
                <main className="hx-hero">
          <section className="hx-copy">
            <div className="hx-kicker hx-rev" style={{'--d':'.02s'}} data-t="kicker">Continuous AI assurance</div>
          ...
          <div className="hx-stage">
            <div className="hx-composite">
              <div className="hx-plate" aria-hidden="true"></div>

          
              <div className="hx-float hx-win" style={{'--d':'.3s'}}>
                <div className="hx-whead">
                  <h2 data-t="wt">Assurance posture</h2>
                  <button className="hx-wbtn" data-t="wb">Start assessment</button>
                </div>
                <div className="hx-wtabs"><span className="hx-on" data-t="tb1">Controls</span><span data-t="tb2">Findings</span><span data-t="tb3">Evidence</span></div>

                <div className="hx-wgrid">
                  <div className="hx-mini">
                    <div className="hx-mh"><b data-t="m1">Assessment progress</b><svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M12 4v12m0 0 5-5m-5 5-5-5M5 20h14" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
                    <div className="hx-gaugewrap">
                      <svg width="104" height="96" viewBox="0 0 104 96" aria-hidden="true">
                        <defs><linearGradient id="gg" x1="16" y1="78" x2="88" y2="78" gradientUnits="userSpaceOnUse">
                          <stop offset="0" stopColor="var(--green-lit)"/><stop offset="1" stopColor="var(--green)"/>
                        </linearGradient></defs>
                        <path className="hx-garc" d="M16 78 A44 44 0 1 1 88 78"/>
                        <path className="hx-gfill" stroke="url(#gg)" pathLength="100" d="M16 78 A44 44 0 1 1 88 78"/>
                      </svg>
                      <div className="hx-glabel"><div className="hx-p"><span className="hx-count" data-count="61">0</span>%</div><div className="hx-l" data-t="gl">Scored</div></div>
                    </div>
                  </div>

                  <div className="hx-mini">
                    <div className="hx-mh"><b data-t="m2">Findings by severity</b><svg width="12" height="12" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="8.5" stroke="currentColor" strokeWidth="1.8"/><path d="M12 8v5m0 3h.01" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
                    <div className="hx-legend">
                      <span className="hx-leg"><i style={{background:'var(--green)'}}></i><span data-t="s1">Low</span></span>
                      <span className="hx-leg"><i style={{background:'var(--blue)'}}></i><span data-t="s2">Medium</span></span>
                      <span className="hx-leg"><i style={{background:'var(--amber)'}}></i><span data-t="s3">High</span></span>
                      <span className="hx-leg"><i style={{background:'var(--red)'}}></i><span data-t="s4">Critical</span></span>
                    </div>
                    <div className="hx-bar">
                      <span className="hx-seg" style={{background:'linear-gradient(180deg,var(--green-lit),var(--green))', '--sd':'.65s'}} data-w="47%"></span>
                      <span className="hx-seg" style={{background:'var(--blue)', '--sd':'.8s'}} data-w="28%"></span>
                      <span className="hx-seg" style={{background:'var(--amber)', '--sd':'.95s'}} data-w="17%"></span>
                      <span className="hx-seg" style={{background:'var(--red)', '--sd':'1.1s'}} data-w="8%"></span>
                    </div>
                    <div className="hx-counts"><span style={{width:'47%'}}>9</span><span style={{width:'28%'}}>5</span><span style={{width:'17%'}}>3</span><span>1</span></div>
                  </div>
                </div>

                <div className="hx-trows">
                  <div className="hx-trow">
                    <div><div className="hx-tn">Risk management system</div><div className="hx-tm">EU AI Act · AIA 9.2</div></div>
                    <svg className="hx-ringy" viewBox="0 0 30 30"><circle className="hx-rb" cx="15" cy="15" r="12"/><circle className="hx-rf" cx="15" cy="15" r="12" stroke="var(--green)" style={{'--rd':'.9s'}} data-off="13.6"/></svg>
                    <span className="hx-schip hx-ok" data-t="c_ok">Operating</span>
                  </div>
                  <div className="hx-trow">
                    <div><div className="hx-tn">Management system controls</div><div className="hx-tm">ISO/IEC 42001 · 8.1</div></div>
                    <svg className="hx-ringy" viewBox="0 0 30 30"><circle className="hx-rb" cx="15" cy="15" r="12"/><circle className="hx-rf" cx="15" cy="15" r="12" stroke="var(--green)" style={{'--rd':'1.05s'}} data-off="19.6"/></svg>
                    <span className="hx-schip hx-ok" data-t="c_ok2">Operating</span>
                  </div>
                  <div className="hx-trow">
                    <div><div className="hx-tn">AI risk treatment</div><div className="hx-tm">ISO/IEC 23894 · 6.4</div></div>
                    <svg className="hx-ringy" viewBox="0 0 30 30"><circle className="hx-rb" cx="15" cy="15" r="12"/><circle className="hx-rf" cx="15" cy="15" r="12" stroke="var(--amber)" style={{'--rd':'1.2s'}} data-off="31.7"/></svg>
                    <span className="hx-schip hx-rev" data-t="c_rev">Needs review</span>
                  </div>
                </div>
              </div>

          
              <div className="hx-float hx-flow hx-bob" style={{'--d':'.55s'}}>
                <div className="hx-fhead">
                  <div className="hx-crumb" data-t="fc">WORKFLOWS /</div>
                  <h3 data-t="ft">Re-verification for AI controls</h3>
                  <div className="hx-fmeta">
                    <span className="hx-hl" data-t="fm1">Active</span>
                    <span data-t="fm2">Owner · Cyber team</span>
                    <span data-t="fm3">Runs daily</span>
                  </div>
                </div>
                <div className="hx-fbody">
                  <svg className="hx-fsvg" aria-hidden="true">
                    <path className="hx-fpath" style={{'--pd':'1.15s'}} d="M 86 34 V 60"/>
                    <path className="hx-fpath" style={{'--pd':'1.35s'}} d="M 120 106 C 120 128 52 118 52 142"/>
                    <path className="hx-fpath" style={{'--pd':'1.45s'}} d="M 120 106 C 120 130 120 130 120 142"/>
                    <path className="hx-fpath" style={{'--pd':'1.55s'}} d="M 120 106 C 120 128 190 118 190 142"/>
                    <circle className="hx-fdot" r="2.6" cx="86" cy="47"/>
                  </svg>
                  <div className="hx-fnode hx-a"><div className="hx-fl" data-t="fn1l">Start</div><div className="hx-fv">AIA 9.2</div></div>
                  <div className="hx-fnode hx-b"><div className="hx-fl" data-t="fn2l">Trigger</div><div className="hx-fv" data-t="fn2v">Control readiness changed</div></div>
                  <div className="hx-facts">
                    <div className="hx-fnode"><div className="hx-fl" data-t="fa1l">Create task</div><div className="hx-fv" data-t="fa1v">Evidence linked</div></div>
                    <div className="hx-fnode"><div className="hx-fl" data-t="fa2l">Notify</div><div className="hx-fv" data-t="fa2v">Control owners</div></div>
                    <div className="hx-fnode"><div className="hx-fl" data-t="fa3l">Webhook</div><div className="hx-fv">platform/api</div></div>
                  </div>
                </div>
              </div>

          
              <div className="hx-float hx-toast hx-bob2" style={{'--d':'.75s'}}>
                <span className="hx-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="m5 12.5 4.5 4.5L19 7.5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/></svg></span>
            ...
            <div className="prow2a">
                ...
                <svg className="csvg" viewBox="0 0 560 190" aria-hidden="true">
                  <defs>
                    <linearGradient id="pgrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0" stopColor="var(--pos)" stopOpacity=".3"/>
                      <stop offset=".55" stopColor="var(--pos)" stopOpacity=".1"/>
                      <stop offset="1" stopColor="var(--pos)" stopOpacity="0"/>
                    </linearGradient>
                    <filter id="lglow" x="-20%" y="-40%" width="140%" height="200%">
                      <feDropShadow dx="0" dy="3" stdDeviation="4" floodColor="var(--pos)" floodOpacity=".3"/>
                    </filter>
                  </defs>
                  ...
                  <g className="ptag">
                    ...
                    <path d="M543 26 547.5 31" stroke="var(--pos)" strokeWidth="1.5" strokeLinecap="round"/>
                  </g>
                  <g className="pdot"><circle cx="548" cy="33.9" r="7" fill="var(--pos)" opacity=".18"/><circle cx="548" cy="33.9" r="3.4" fill="var(--pos)"/></g>
                </svg>
              </div>
              ...
              <div className="pc pdonut">
                <div className="chd">
                  ...
                  <button className="lnk" data-modal="controls">View all controls</button>
                </div>
                <div className="pbody">
                  <div className="dwrap">
                ...
                <div className="cdbar"><i className="cp" data-w="32.6"></i><i className="cm" data-w="3.7"></i><i className="cj" data-w="1.6"></i></div>
                  <div className="cdcap">61 PASSING &middot; 7 MINOR &middot; 3 MAJOR &middot; OF 187 TRACKED</div>
                  <div className="astrip a" data-modal="controls">
            ...
            <div className="prow2b">
              <div className="pc pcov">
                <div className="chd">
                  ...
                  <button className="lnk" data-modal="cats">View all categories</button>
                </div>
              ...
              <div className="pc pguard">
                ...
                <div className="astrip r2">
                  ...
                  <button className="avd" data-modal="leak">VIEW DETAILS</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="feat" id="f-govern">
        <div className="wrap feat-in">
          <div className="cpy">
                  ...
                  <div className="krow" style={{gridTemplateColumns:'1fr 1fr'}}>
                    ...
                    <div className="pcard matrix">
                      ...
                      <svg viewBox="0 0 300 168" aria-hidden="true">
                        ...
                        <g fontFamily="JetBrains Mono,monospace" fontSize="6.5" fill="var(--ink-3)" letterSpacing=".08em">
                        ...
                        <g className="pt">
                          ...
                          <text x="90" y="23" textAnchor="middle" fontFamily="JetBrains Mono,monospace" fontSize="6.3" fill="var(--amber)" letterSpacing=".08em">RISK APPETITE</text>
      ...
      <section className="feat flip" id="f-guardrails">
        <div className="wrap feat-in">
          <div className="cpy">
      ...
      <div className="modal" id="modal" hidden>
        ...
        <div className="modal-card" role="dialog" aria-modal="true" aria-labelledby="mTitle">
          <div className="modal-head"><h4 id="mTitle"></h4><button className="mx" data-close aria-label="Close">&#10005;</button></div>
          <div className="modal-body" id="mBody"></div>
        </div>
      </div>
